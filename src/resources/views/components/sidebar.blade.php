<div class="col-3 rounded border py-2">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        <a class="nav-link border-bottom active" id="v-pills-customization-tab" data-toggle="pill" href="#v-pills-customization" role="tab" aria-controls="v-pills-customization" aria-selected="true">Personalização</a>
        ...
        <a class="nav-link border-bottom" id="v-pills-searchCustomization-tab" data-toggle="pill" href="#v-pills-searchCustomization" role="tab" aria-controls="v-pills-searchCustomization" aria-selected="false">Buscar Personalização</a>
